...
The New Deliverance marketing site is live at [nd.autonateai.com](https://nd.autonateai.com/). Its local repo lives in `~/code/new-deliverance` and is published from the `AutoNateAI/new-deliverance` GitHub repo.
...
<img src="/img/marketing-site-map.svg" alt="Diagram showing the New Deliverance marketing site structure from shared content to pages to GitHub Pages deployment." />
...
- GitHub Actions
- GitHub Pages
- Custom domain: `nd.autonateai.com`
